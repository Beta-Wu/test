...
<font color=red>${result}</font>
   <table>
     ...
     <tr><td><td style="color:red" id="results"></td></tr><tr>
     <tr><td></td><tr>
     <tr><td>密码:</td>
     <td><input type="password" name="password" id="password" required/></td></tr>
     <tr><td></td><tr>
     <tr><td></td><tr>
     <tr><td>确认密码:</td>
     <td><input type="password" name="againpassword" id="againpassword" required/></td> </tr>
     <tr><td></td><tr>
     <tr><td></td><tr> 
     <tr><td>手机号码:</td>
     <td><input type="text" name="phone" id="phone" maxlength=11 onblur="validPhone(this)" required/></td></tr>
     <tr><td></td><tr>
     <tr><td></td><tr>  
     <tr><td>身份:</td>
     <td><select name="identity">
     <option value="customer" id="identity">顾客</option>
     <option value="merchant" id="identity">商家</option>
     </select>
     <tr><td></td><tr>
     <tr><td></td><tr>   
     </table>    
    <label><tr><td><input type="submit" name="submit" value="提交"></td>
